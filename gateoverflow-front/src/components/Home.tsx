    ...
    <div className='my-10 xs:my-5'>
      <div className='flex flex-col items-center px-6 mx-auto lg:py-0'>
        <div className='w-[800px] sm:w-[500px] xs:w-[300px]'>
          ...
          {/* subjects */}
          <div className='p-2 grid grid-cols-2 gap-5 mt-5 sm:grid-cols-1 xs:grid-cols-1'>
            <div className='bg-[#36393F] p-5 rounded-md text-white flex items-center hover:bg-purple-700 duration-500 xs:p-4 xs:w-full'>
              <div className='text-4xl xs:text-[10px]'><FcGenealogy/></div>
